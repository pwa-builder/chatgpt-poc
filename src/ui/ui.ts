...
class AppRoot extends LitElement {
  ...
  generateManifest = async function(): Promise<void> {
    ...
    if (result.status == 200){
      ...
      this.icons = generated?.icon || null;
  ...
  render() {
    return html`
      <sl-card class="card-header card-footer">
        ...
        ${choose(this.stage, [
          ['start', () => html`This prototype explores possibilities and horizons of using OpenAI in PWA development.`],
          ...
          ['url', () => html`
            ...
            `],
          ['manifestGen', () => html`Generating Web Manifest and App Icon...`],
          ['compare', () => html`
          <section class="compare">
            ...
            ${this.icons?.length? 
              html`<sl-card class="card-image icons">
                ${this.icons.map((icon) =>
                  html` <img src=${icon.url} alt="app icon" />`
                )}
